  ...
  const courses = [
    {
      ...
      description: "Learn to build websites and web apps that people actually use. Start with the basics and work up to advanced projects.",
      duration: "12 weeks",
    ...
    },
    {
      ...
      description: "Learn how to build smart apps and systems that can make decisions, recognize patterns, and solve complex problems.",
      duration: "16 weeks",
      schedule: "Weekends",
      price: "$3,299",
      features: [
    ...
    },
    {
      ...
      description: "Turn numbers into insights. Learn to find patterns in data and create charts that tell compelling stories.",
      duration: "10 weeks",
      schedule: "Flexible",
      price: "$1,899",
      features: [
